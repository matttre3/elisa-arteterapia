        ...
        <Container>
          <div className="flex flex-col items-center justify-center gap-4 pb-12 pt-12">
            ...
            <p className="text-center font-anaheimregular text-xl tracking-widest text-standard md:text-2xl">
              ...
              Sarò felice di rispondere alle tue domande e di aiutarti a
              scoprire come l&apos;arteterapia può supportare il tuo percorso di
              benessere. Puoi raggiungermi attraverso il modulo qui sotto, via
              email o sui social media.
            </p>
